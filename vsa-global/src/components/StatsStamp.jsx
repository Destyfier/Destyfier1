...
function Stamp({ s, delay }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="mono" style={{ fontSize: 10, letterSpacing: '0.12em', color: 'var(--stamp)', marginBottom: 2 }}>
          {s.code}
        </span>
      ...
      <span className="mono" style={{ fontSize: 12, letterSpacing: '0.04em', textTransform: 'uppercase', color: 'var(--slate)', textAlign: 'center' }}>
        {s.label}
      </span>
    </motion.div>
  )
